            ...
            <div className="space-y-6 p-4  w-full max-w-md">
              ...
              <div>
                ...
                <div className="space-y-2 mt-2">
                  ...
                  <CheckboxWithLabel
                    label="Must have Showcase"
                    tooltip="Homes with virtual or showcase tours."
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-2">
                  <SelectInput
                    value={squareFeetMin}
                    onChange={setSquareFeetMin}
                    placeholder="No Min"
                  />
                  <span className="">-</span>
                  <SelectInput
                    value={squareFeetMax}
                    onChange={setSquareFeetMax}
                    placeholder="No Max"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-2">
                  <SelectInput
                    value={lotSizeMin}
                    onChange={setLotSizeMin}
                    placeholder="No Min"
                  />
                  <span className="">-</span>
                  <SelectInput
                    value={lotSizeMax}
                    onChange={setLotSizeMax}
                    placeholder="No Max"
                  />
                </div>
              </div>
